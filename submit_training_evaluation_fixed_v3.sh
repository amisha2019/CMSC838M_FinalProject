...
echo ""
echo "Fixes applied to the PI-EquiBot codebase:"
echo "1. Fixed DDPMScheduler .to(device) issue by removing the call"
echo "2. Fixed normalizer shape mismatch with a robust implementation"
echo "3. Added handling for missing configuration parameters"
echo "4. Fixed cfg.train vs cfg.training key mismatch"
echo "5. Added library path export: LD_PRELOAD=$CONDA_PREFIX/lib/libstdc++.so.6"
</rewritten_file> 